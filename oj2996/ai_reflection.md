...
| OJ submission ID, if submitted | 560426 |
| OJ status | Pass |
...
```text
I asked AI to review my first plan and help me on for loop to make it cleaner
```
...
```text
It helped me better understand how a for loop works
```
...
```text
I did most of the coding and only let it help me on for loop to make it look cleaner
```
...
```text
I learned a new way to use for loop because before this i only know "for i in range" that help me from using "for i in range(len(text))"
```
